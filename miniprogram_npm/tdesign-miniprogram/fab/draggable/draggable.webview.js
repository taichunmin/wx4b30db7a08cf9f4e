...
var c8H=_mz(z,'view',['bind:touchend',0,'bind:touchmove',1,'bind:touchstart',1,'class',2,'style',3],[],e,s,gg)
var h9H=_n('slot')
_(c8H,h9H)
_(r,c8H)
return r
...
var noCss=typeof __vd_version_info__!=='undefined'&&__vd_version_info__.noCss===true;if(!noCss){__wxAppCode__['miniprogram_npm/tdesign-miniprogram/fab/draggable/draggable.wxss'] = setCssToHead([".",[1],"t-float-left{float:left}\n.",[1],"t-float-right{float:right}\n@-webkit-keyframes tdesign-fade-out{from{opacity:1}\nto{opacity:0}\n}@keyframes tdesign-fade-out{from{opacity:1}\nto{opacity:0}\n}.",[1],"hotspot-expanded.",[1],"relative{position:relative}\n.",[1],"hotspot-expanded::after{bottom:0;content:\x22\x22;display:block;left:0;position:absolute;right:0;top:0;-webkit-transform:scale(1.5);transform:scale(1.5)}\n.",[1],"t-draggable{position:absolute}\n",],undefined,{path:"./miniprogram_npm/tdesign-miniprogram/fab/draggable/draggable.wxss"});
}