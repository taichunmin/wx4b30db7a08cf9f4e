...
e = (t = i).lib.WordArray, t.enc.Base64 = {
  ...
  function(t) {
    ...
    for (var s = i, c = (f = s.lib).WordArray, a = f.Hasher, f = s.algo, h = [], u = 0; 64 > u; u++) h[u] = 4294967296 * t.abs(t.sin(u + 1)) | 0;
    f = f.MD5 = a.extend({
      _doReset: function() {
  ...
  function() {
    ...
    u.Encryptor = u.extend({
      ...
      pad: function(t, e) {
        for (var r, i = (r = (r = 4 * e) - t.sigBytes % r) << 24 | r << 16 | r << 8 | r, o = [], s = 0; s < r; s += 4) o.push(i);
  ...
  function() {
    for (var t = i, e = t.lib.BlockCipher, r = t.algo, n = [], o = [], s = [], c = [], a = [], f = [], h = [], u = [], p = [], d = [], l = [], y = 0; 256 > y; y++) l[y] = 128 > y ? y << 1 : y << 1 ^ 283;
    var _ = 0,
      v = 0;
    for (y = 0; 256 > y; y++) {
      ...
      var B = l[_],
        k = l[B],
        m = l[k],
        x = 257 * l[g] ^ 16843008 * g;
      s[_] = x << 24 | x >>> 8, c[_] = x << 16 | x >>> 16, a[_] = x << 8 | x >>> 24, f[_] = x, x = 16843009 * m ^ 65537 * k ^ 257 * B ^ 16843008 * _, h[g] = x << 24 | x >>> 8, u[g] = x << 16 | x >>> 16, p[g] = x << 8 | x >>> 24, d[g] = x, _ ? (_ = B ^ l[l[l[m ^ B]]], v ^= l[l[v]]) : _ = v = 1
    }
      ...
      _doReset: function() {
        for (var t = (r = this._key).words, e = r.sigBytes / 4, r = 4 * ((this._nRounds = e + 6) + 1), i = this._keySchedule = [], o = 0; o < r; o++)
          if (o < e) i[o] = t[o];
            ...
            var s = i[o - 1];
            o % e ? 6 < e && 4 == o % e && (s = n[s >>> 24] << 24 | n[s >>> 16 & 255] << 16 | n[s >>> 8 & 255] << 8 | n[255 & s]) : (s = n[(s = s << 8 | s >>> 24) >>> 24] << 24 | n[s >>> 16 & 255] << 16 | n[s >>> 8 & 255] << 8 | n[255 & s], s ^= S[o / e | 0] << 24), i[o] = i[o - e] ^ s
          } for (t = this._invKeySchedule = [], e = 0; e < r; e++) o = r - e, s = e % 4 ? i[o] : i[o - 4], t[e] = 4 > e || 4 >= o ? s : h[n[s >>> 24]] ^ u[n[s >>> 16 & 255]] ^ p[n[s >>> 8 & 255]] ^ d[n[255 & s]]
      },
  ...
  }(), i.encrypt = function(t, e, r) {
    return function(t, e, r) {
      return e = i.enc.Utf8.parse(e), r = i.enc.Utf8.parse(r), i.AES.encrypt(t, e, {
        iv: r,
        mode: i.mode.CBC,
        padding: i.pad.Pkcs7
      }).toString()
    }(t, e, r)
  }, i.decrypt = function(t, e, r) {
    return function(t, e, r) {
      e = i.enc.Utf8.parse(e), r = i.enc.Utf8.parse(r);
      var n = i.AES.decrypt(t, e, {
        iv: r,
        mode: i.mode.CBC,
        padding: i.pad.Pkcs7
      });
      return n = i.enc.Utf8.stringify(n)
    }(t, e, r)
